...
export const mockPosts: Post[] = [
  {
    id: 'post_1',
    authorId: '1',
    content: 'Just finished implementing React Native Reanimated 4.x gestures! The new API is much cleaner 🚀',
    likesCount: 24,
    commentsCount: 7,
  ...
  },
  {
    id: 'post_2',
    authorId: '2',
    content: 'Working on some new UI designs for a social app. Love how NativeWind makes styling so much easier! 🎨',
    likesCount: 18,
    commentsCount: 3,
  ...
  },
  {
    id: 'post_3',
    authorId: '3',
    content: 'Finally released my space exploration game demo! Check it out and let me know what you think 🎮🚀',
    likesCount: 45,
    commentsCount: 12,
  ...
  },
  {
    id: 'post_4',
    authorId: '1',
    content: 'Pro tip: Use absolute imports with path aliases to keep your React Native code clean and maintainable 💡',
    likesCount: 31,
    commentsCount: 5,
