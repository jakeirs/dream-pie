...
test.describe('BottomSheet Demo Component', () => {
  ...
  test('should display the main page with BottomSheet trigger button', async ({ page }) => {
    ...
    // Look for the "Open Bottom Sheet" button
    const openButton = page.locator('text=Open Bottom Sheet');
  ...
  test('should open BottomSheet when Open Bottom Sheet button is clicked', async ({ page }) => {
    // Wait for the Open Bottom Sheet button to be visible
    const openButton = page.locator('text=Open Bottom Sheet');
    ...
    const bottomSheetTitle = page.locator('text=🎉 Bottom Sheet Demo');
    await expect(bottomSheetTitle).toBeVisible();
    
    // Check if BottomSheet description is visible
    const description = page.locator('text=This is a React Native Bottom Sheet with gesture handling');
  ...
  test('should close BottomSheet when Close Bottom Sheet button is clicked', async ({ page }) => {
    ...
    // Now click the Close Bottom Sheet button
    const closeButton = page.locator('text=Close Bottom Sheet');
